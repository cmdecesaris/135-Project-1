...
pairs(Birthweight~Length+Headcirc+Gestation+mnocig+fnocig+mage+fage+fheight+mheight+mppwt,data=smok, 
      lower.panel = panel_cor)

```

```{r warning=FALSE}
scatterplotMatrix(~Birthweight+Length+Headcirc+Gestation+mnocig+fnocig+mage+fage+fheight+mheight+mppwt, data = smok, reg.line = lm, smooth = TRUE, span = 0.5,
diagonal = "histogram")
```
```{r}
